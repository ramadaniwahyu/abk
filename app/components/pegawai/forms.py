...
class PegawaiForm(FlaskForm):
    ...
    satker = QuerySelectField('Satuan Kerja', query_factory=lambda: Satker.query.order_by(Satker.created_on.asc()).all(), get_label='name', allow_blank=True, blank_text='Belum ada pilihan')
